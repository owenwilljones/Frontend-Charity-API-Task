...
describe('DonationList API call on mount', async () => {
    ...
    it('formats the donation results in the state correctly', () => {
        ...
        expect(donationListWrapper.state('donations')).toHaveProperty(currencyCode, 'GBP');
        expect(donationListWrapper.state('donations')).toHaveProperty(donationDate, 'Thu Nov 15 2018 19:06:05 GMT');
